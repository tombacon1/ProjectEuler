...
internal class EulerProject13
{
    static readonly string question = "Work out the first ten digits of the sum of the following\r\n" + 
    ...
    static BigInteger[] inputNumbers = new BigInteger[100] {BigInteger.Parse("37107287533902102798797998220837590246510135740250"),
    ...
    static void Main()
    {
        ...
        BigInteger sumOfInputs= BigInteger.Zero;
        
        foreach(BigInteger bigInt in inputNumbers)
            sumOfInputs += bigInt;

        string firstTenCharsOfSum = sumOfInputs.ToString().Substring(0, 10);

        sw.Stop();
        Console.WriteLine("Elapsed: " + sw.ElapsedMilliseconds + "ms");
        Console.WriteLine("Result: " + firstTenCharsOfSum);
        Console.ReadLine();
    }
}
